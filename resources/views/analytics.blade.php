                ...
                <div class="card cta-box overflow-hidden">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <h3 class="mt-0 fw-normal cta-box-title mb-3">Enhance your <b>Campaign</b> for better
                                    outreach</h3>
                                <a href="#" class="link-success link-offset-3 fw-bold">Go Premium <i
                                        class="ri-arrow-right-line"></i></a>
                            </div>
                            <img class="ms-3" src="/images/svg/email-campaign.svg"
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="text-uppercase fs-13 mt-0 text-truncate" title="Views per minute">Views per
                                    minute</h5>
