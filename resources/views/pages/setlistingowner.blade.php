                    ...
                    <div class="row">
                        <div class="col-sm-3 mb-2 mb-sm-0">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                @forelse($listingOwnerData['listings'] as $listing)
                                    <a class="nav-link mt-2 {{$loop->first ? 'active':''}}" id="v-pills-{{$listing['id']}}-tab"
                                       data-bs-toggle="pill"
...
{{--                                                </a>--}}
    ...
    {{$listingOwnerData['listings']->links('vendor.pagination.bootstrap-5')}}
@endsection
