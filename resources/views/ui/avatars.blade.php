@extends('layouts.vertical', ['page_title' => 'Avatars', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 text-center">
                                <img src="/images/users/avatar-6.jpg" alt="image" class="img-fluid rounded" width="120" />
                                <p class="mb-0">
                                    <code>.rounded</code>
                                </p>
                            </div>
