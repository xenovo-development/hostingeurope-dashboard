@extends('layouts.vertical', ['page_title' => 'Modals', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Specify the position for the modal. You can display modal at top, bottom, center or right of page by specifying
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">A rendered modal with header having contexual background color.</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">A rendered modal with header, body and footer having contexual background color.</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Display a series of modals one by one to guide your users on multiple aspects or take step wise input.</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Toggle between multiple modals with some clever placement of the <code>data-bs-target</code> and <code>data-bs-toggle</code> attributes.</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Another override is the option to pop up a modal that covers the user viewport, available via modifier classes that are placed on a <code>.modal-dialog</code></p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">When backdrop is set to static, the modal will not close when clicking outside it. Click the button below to try it.</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Have a bunch of buttons that all trigger the same modal with slightly different contents? Use
