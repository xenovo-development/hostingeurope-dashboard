@extends('layouts.vertical', ['page_title' => 'Tabs', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14 mb-3">Simple widget of tabbable panes of local content.</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14 mb-3">Using class <code>.nav-justified</code>, you can force your <code>tab menu items</code> to use the full available width.</p>
