@extends('layouts.vertical', ['page_title' => 'Typography', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Traditional heading elements are designed to work best in the meat of your page content. When you need a heading to stand out, consider using a display heading—a larger, slightly more opinionated heading style.</p>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">All HTML headings, <code>&lt;h1&gt;</code> through
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Styling for common inline HTML5 elements.</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Available color variations.</p>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">A list of items in which the order does not explicitly matter.</p>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">A list of items in which the order does explicitly matter.</p>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14"><strong>This only applies to immediate children
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">For quoting blocks of content from another source within your document. Wrap <code>&lt;blockquote class="blockquote"&gt;</code> around any <abbr title="AttexText Markup Language">HTML</abbr> as the quote.</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Align terms and descriptions horizontally by using our grid system’s predefined classes (or semantic mixins). For longer terms, you can optionally add a <code>.text-truncate</code> class to truncate the text with an ellipsis.</p>
