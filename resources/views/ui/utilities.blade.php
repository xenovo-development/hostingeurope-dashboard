@extends('layouts.vertical', ['page_title' => 'Utilites', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Utilites</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Utilites</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Similar to the contextual text color classes, set the background of an element to any contextual class. Background
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">By adding a <code>.bg-gradient</code> class, a linear gradient is added as background image to the backgrounds. This
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Similar to the contextual text color classes, set the background of an element to any contextual class. Background utilities do not set <code>color</code>, so in some cases you’ll want to use <code>.text-*</code> <a href="https://getbootstrap.com/docs/5.3/utilities/colors/">color utilities</a>.</p>
                        <div class="row">
                            <div class="col-12">
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Color and background helpers combine the power of our <code>.text-*</code> utilities and <code>.bg-*</code> utilities in one class. Using our Sass <code>color-contrast()</code> function, we automatically determine a contrasting <code>color</code> for a particular <code>background-color</code>.</p>
                        <div class="d-flex flex-column gap-2">
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14"><code>background-color</code> utilities are generated with Sass using CSS variables. This
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-14">Colorize text with color utilities. If you want to colorize links, you can use the <code>.link-*</code> helper classes which have <code>:hover</code>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">text color utilities are generated with Sass using CSS variables. This allows for real-time color
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">The <code>opacity</code> property sets the opacity level for an element. The opacity level describes the transparency
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Use border utilities to <b>add</b> an element’s borders. Choose from all borders or one at a time.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Use border utilities to <b>remove</b> an element’s borders. Choose from all borders or one at a time.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Change the border color using utilities built on our theme colors.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">choose from any of the <code>.border-opacity</code> utilities:</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Add classes to an element to easily round its corners.</p>
                            ...
                            <div class="d-flex align-items-start flex-wrap gap-2">
                                ...
                                <img src="/images/small/small-2.jpg" class="avatar-lg w-auto rounded-pill" alt="rounded-pill">
                            </div>
                        </div> <!-- end card-body -->
                    </div> <!-- end card-->
                </div> <!-- end col -->
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Use the scaling classes for larger or smaller rounded corners. Sizes range from <code>0</code> to <code>5</code>.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Use <code>user-select-all</code>, <code>user-select-auto</code>, or
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Bootstrap provides <code>.pe-none</code> and <code>.pe-auto</code> classes to prevent or add element interactions.</p>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Adjust the <code>overflow</code> property on the fly with four default values and classes. These classes are not
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Arrange elements easily with the edge positioning utilities. The format is <code>{property}-{position}</code>.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">In addition, you can also center the elements with the transform utility class <code>.translate-middle</code>.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">By adding <code>.translate-middle-x</code> or <code>.translate-middle-y</code> classes, elements can be positioned only in horizontal or vertical direction.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">While shadows on components are disabled by default in Bootstrap and can be enabled via
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Width utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Height utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for
                                <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code> by default. Modify
                                those values as you need to generate different utilities here.
                            </p>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-14">Change the value of the <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/object-fit"><code>object-fit</code> property</a> with our responsive <code>object-fit</code> utility classes. This property tells the content to fill the parent container in a variety of ways, such as preserving the aspect ratio or stretching to take up as much space as possible.</p>

                            <div class="d-flex align-items-start flex-wrap gap-3 text-center">
                                <div>
                                    <img src="/images/small/small-1.jpg" class="object-fit-contain border rounded avatar-xl" alt="...">
                                    <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-contain</code></p>
                                </div>
                                <div>
                                    <img src="/images/small/small-1.jpg" class="object-fit-cover border rounded avatar-xl" alt="...">
                                    <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-cover</code></p>
                                </div>
                                <div>
                                    <img src="/images/small/small-1.jpg" class="object-fit-fill border rounded avatar-xl" alt="...">
                                    <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-fill</code></p>
                                </div>
                                <div>
                                    <img src="/images/small/small-1.jpg" class="object-fit-scale border rounded avatar-xl" alt="...">
                                    <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-scale</code></p>
                                </div>
                                <div>
                                    <img src="/images/small/small-1.jpg" class="object-fit-none border rounded avatar-xl" alt="...">
